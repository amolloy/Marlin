...
#define STRING_CONFIG_H_AUTHOR "(Andy M, Ender-5 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Andy's Ender-5 Pro 4.2.7"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48, -5, 0 }
